...
const Form__AltaEmpleado_rellenarDatosPersonalesYLaboralesEmpleado: React.FC<any> =
	(props: any) => {
		const [formApi, setFormApi] = useState<any>();
		const [empleado__apellido1, set__empleado__apellido1] =
			useState<string>('');
		const [empleado__apellido2, set__empleado__apellido2] =
			useState<string>('');
		...
		const [empleado__idempleado, set__empleado__idempleado] =
			useState<number>();
			...
			<div className={'pf-c-form'}>
				<Card>
					<CardBody className='pf-c-form'>
						...
						<FormGroup
							fieldId={'uniforms-0006-000e'}
							label={'Nombre'}
							isRequired={false}>
							<TextInput
								name={'empleado.nombre'}
								id={'uniforms-0006-000e'}
								isDisabled={false}
								placeholder={''}
								type={'text'}
						...
						<FormGroup
							fieldId={'uniforms-0006-000h'}
							label={'Telefono'}
							isRequired={false}>
							<TextInput
								name={'empleado.telefono'}
								id={'uniforms-0006-000h'}
								isDisabled={false}
								placeholder={''}
								type={'text'}
...
export default Form__AltaEmpleado_rellenarDatosPersonalesYLaboralesEmpleado;
